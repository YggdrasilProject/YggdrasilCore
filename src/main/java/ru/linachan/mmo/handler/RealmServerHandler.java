...
public class RealmServerHandler implements ServerHandler {
    ...
    public RealmServerHandler(YggdrasilCore yggdrasilCore) {
        core = yggdrasilCore;

        authManager = yggdrasilCore.getManager(YggdrasilPluginManager.class).get(MMOPlugin.class).getAuthManager();
        sessionManager = yggdrasilCore.getManager(YggdrasilPluginManager.class).get(MMOPlugin.class).getSessionManager();
    }
