...
public class YggdrasilConfigTest extends YggdrasilTestBase {

    private File configFile;
    private YggdrasilConfig config;
    ...
    public void setUp() throws Exception {
        ...
        config = YggdrasilConfig.readConfig(configFile);
    }
    ...
    public void testStringWithOddQuotes() {
        Assert.assertEquals("noValue", config.getString("test.group.stringParameterWithOddQuotes", "noValue"));
    }
